  ...
  getMatches( text ) {
    ...
    */
    ...
    for (let i = 0; i < this.input.length; i++) {
      // console.log(this.input[i].textContent.toUpperCase().includes(text.toUpperCase()));
      if (this.input[i].textContent.toUpperCase().includes(text.toUpperCase()) == true) {
        // console.log(this.input[i].textContent);
        arr.push({text: this.input[i].textContent, value: '1'});
